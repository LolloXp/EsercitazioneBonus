/*! \file Main(2).cpp
    \brief Main file of the project Esercitazione_Bonus
...
int main() {
    ...
    start:
        ...
        /// @brief switch for the first interface
        switch (scelta1) {
        ...
        case 5: /// @brief Exit case
            if(n != 0)/// @brief because if u don't create any object u don't have to delete nothing
            for (int k = 0; k <= n; k++) {
                delete p[k];
                p[k] = NULL;
